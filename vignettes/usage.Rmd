...
The package includes a C++ implementation using RcppArmadillo for improved performance:
```{r}
# Fit using C++ version
set.seed(123)
...
The C++ implementation provides significant performance improvements, especially for larger datasets and more iterations.
